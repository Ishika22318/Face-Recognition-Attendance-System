...
class Face_Recognition_System:
    ...
    def __init__(self,root):
        ...
        b2=Button(bg_img,text="Register Here",command=self.student_details,cursor="hand2",font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        ...
        b1.place(x=580,y=100,width=220,height=220)

        b2=Button(bg_img,text="Face Detector",cursor="hand2", command = self.face_data,font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        b2.place(x=580,y=300,width=220,height=40)
        ...
        b1.place(x=960,y=100,width=220,height=220)

        b2=Button(bg_img,text="Attendance",cursor="hand2",command=self.attendance_data,font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        b2.place(x=960,y=300,width=220,height=40)
        ...
        b1.place(x=1340,y=100,width=220,height=220)

        b2=Button(bg_img,text="Help",cursor="hand2",command=self.help_data,font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        b2.place(x=1340,y=300,width=220,height=40)
        ...
        b2=Button(bg_img,text="Train Face",cursor="hand2",command=self.train_data,font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        ...
        b1.place(x=580,y=400,width=220,height=220)

        b2=Button(bg_img,text="Photos data",cursor="hand2",command=self.open_img,font=("times new roman",25,"bold"),bg="darkblue",fg="white")
        b2.place(x=580,y=600,width=220,height=40)
        ...
        b1.place(x=960,y=400,width=220,height=220)
        ...
        b2.place(x=960,y=600,width=220,height=40)
