...
class Register:
    def __init__(self,root):
        ...
        # fourth image
        img3 = Image.open(r"college_images\img23.jpeg")
        ...
        main_frame.place(x=0,y=45,width=1920,height=730)

        # left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Enter your details",font=("times new roman",15,"bold"))
        Left_frame.place(x=20,y=10,width=900,height=680)

        img_left = Image.open(r"college_images\img7.jpeg")
        img_left = img_left.resize((800,180),Image.ANTIALIAS)
        self.photoimg_left = ImageTk.PhotoImage(img_left)

        f_lbl = Label(Left_frame,image = self.photoimg_left)
        f_lbl.place(x=50,y=0,width=800,height=180)
        ...
        current_course_frame.place(x=20,y=185,width=860,height=150)
        ...
        class_Student_frame.place(x=20,y=335,width=860,height=315)
        ...
        btn_frame.place(x=20,y=215,width=815,height=40)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=17,font=("times new roman",15,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times new roman",15,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=17,font=("times new roman",15,"bold"),bg="blue",fg="white")
        ...
        btn_frame1.place(x=20,y=253,width=815,height=35)

        take_photo_btn = Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=34,font=("times new roman",15,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=1)

        update_photo_btn = Button(btn_frame1,text="Update Photo Sample",width=34,font=("times new roman",15,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Users\agarwal\Desktop\face_recognition_system\college_images\img24.jpeg")
        img_right = img_right.resize((600,180),Image.ANTIALIAS)
        self.photoimg_right = ImageTk.PhotoImage(img_right)

        f_lbl = Label(Right_frame,image = self.photoimg_right)
        f_lbl.place(x=150,y=0,width=600,height=180)


        # ********Search System********
        Search_frame=LabelFrame(Right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",15,"bold"))
        Search_frame.place(x=20,y=185,width=860,height=80)
        ...
        table_frame.place(x=20,y=275,width=860,height=370)
